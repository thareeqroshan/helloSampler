...
{
    const auto textBoxWidth = 40;
    const auto textBoxHeight = 20;
    
    mAttackSlider.setSliderStyle (Slider::SliderStyle::RotaryVerticalDrag);
    mAttackSlider.setTextBoxStyle (Slider::TextBoxBelow, false, textBoxWidth, textBoxHeight);
    ...
    mDecaySlider.setTextBoxStyle (Slider::TextBoxBelow, false, textBoxWidth, textBoxHeight);
    ...
    mSustainSlider.setTextBoxStyle (Slider::TextBoxBelow, false, textBoxWidth, textBoxHeight);
    ...
    mReleaseSlider.setTextBoxStyle (Slider::TextBoxBelow, false, textBoxWidth, textBoxHeight);
